...
public class ContasPagarPagamentoTableModel extends AbstractInternalFrameTable {
	...
	private final List<PagamentoContasProjection> rows;
	private List<String> colunas = new ArrayList<>();
	private NumberFormat codigoContasReceberFormat = NumberFormat.getNumberInstance();
	private NumberFormat numberFormat = NumberFormat.getNumberInstance();
	protected EventListenerList eventListenerList = new EventListenerList();

	public ContasPagarPagamentoTableModel(List<PagamentoContasProjection> rows) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		PagamentoContasProjection pagamentoContasVO = rows.get(rowIndex);

		switch (columnIndex) {

		case 0:
			return codigoContasReceberFormat.format(pagamentoContasVO.getIdContasPagar());
	...
	private boolean validarValor(PagamentoContasProjection pagamentoContasVO, BigDecimal aValue) {
	...
	private void recalcularValorPagar(PagamentoContasProjection vo) {
	...
	public List<PagamentoContasProjection> getRows() {

...
public class FrmSaida extends JDialog {
	...
	private final FaturamentoDetalhe faturamentoDetalhe;
	...
	public FrmSaida(FaturamentoDetalhe faturamentoDetalhe, Long codigoUsuario) {

		this.faturamentoDetalhe = faturamentoDetalhe;
	...
	private void preencherDetalhe() {
		...
		if (this.validarCampos()) {
			...
			faturamentoDetalhe.setMotorista(pesquisaMotorista.getObjetoPesquisado());
			faturamentoDetalhe.setVeiculo(pesquisaVeiculo.getObjetoPesquisado());
			faturamentoDetalhe.setNumeroDocumento(txDocumento.getText());
			faturamentoDetalhe.setValorBruto(txTotal.getValue());
			faturamentoDetalhe.setValorAcrescimo(txAcrescimo.getValue());
			faturamentoDetalhe.setValorDesconto(txDesconto.getValue());

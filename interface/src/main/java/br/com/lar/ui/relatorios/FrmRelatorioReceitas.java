...
public class FrmRelatorioReceitas extends AbstractInternalFrame {

	private static final long serialVersionUID = 1L;

	private FaturamentoSaidaService faturamentoSaidaService = new FaturamentoSaidaService();
	...
	public FrmRelatorioReceitas(Long permissaoPrograma, Long codigoUsuario) {
	...
	private void initComponents() {
		...
		pnlPagamento.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Valor Receita", TitledBorder.CENTER,
				TitledBorder.TOP, null, new Color(0, 0, 0)));

		pnlActions.setBounds(7, 223, 536, 32);
		pnlVencimento.setBounds(7, 160, 280, 52);
		pnlPagamento.setBounds(291, 160, 252, 52);
	...
	private void gerarRelatorio() {
		...
		try {
			...
			List<FaturamentoProjection> faturamentoEntradasCabecalhos = faturamentoSaidaService.filtrarFaturamento(pesquisaFaturamentoVO);

			new FaturamentoReportBuilder()
					.build("Relatório de Receitas", montarSubTitulo(), !LongUtil.isNullOrZero(pesquisaFaturamentoVO.getCodigoVeiculo()))

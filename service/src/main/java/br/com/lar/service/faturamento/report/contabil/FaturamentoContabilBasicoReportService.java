...
public class FaturamentoContabilBasicoReportService {
	...
	public List<FaturamentoBrutoVO> filtrarFaturamentoContabilBasico(
		...
		faturamentoBrutoReport
				.add(new FaturamentoBrutoVO("FATURAMENTO BRUTO", faturamentoBrutoContabil, BigDecimal.ZERO, 1));
		...
		faturamentoBrutoReport.add(new FaturamentoBrutoVO("FATURAMENTO LIQUIDO",
				faturamentoBrutoContabil.subtract(despesasFinanceiras), BigDecimal.ZERO, 1));

...
public class FaturamentoSocialHistoricoReportService {
	...
	public List<FaturamentoBrutoVO> filtrarFaturamentoSocialHistorico(
		...
		mapaCreditos.forEach((key, value) -> faturamentoBrutoReport.add(new FaturamentoBrutoVO(key, BigDecimal.ZERO,
